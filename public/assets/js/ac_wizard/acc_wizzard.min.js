! function(t, e, a, n) {
  function s(a, s) {
    ...
    /**
     * FUNCION QUE POR AJAX ACTUALIZA EL ESTADO DE LA ETAPA
     * @param stage: ID de la etapa que se quiere actualizar a terminada
     */
    function sd(stage){
      $.ajax({
        type: "post",
        ...
        success: function(rj) {
          if (rj == 1){
            $('#reload_stage_'+stage).css('display', 'inline');
            $('#stage_inputs_group_'+stage).attr('disabled', true);
          }
        },
