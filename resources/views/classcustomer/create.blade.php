...
@section('title','Crear clase de cliente')
@section('page_parent',"Crear Clases")
    ...
    <div class="col-md-12">
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          ...
          <div class="col-lg-12">
            {!! Html::ul($errors->all()) !!}
            {!! Form::open(array('url' => 'class/store', 'id'=>'newClassCustomer')) !!}
            <div class="row">
              <div class="col-lg-6">
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    {!! Form::text('arrears', Input::old('arrears'), array('class' => 'form-control', 'onKeyDown'=>'verifyClass()', 'id'=>'arrears')) !!}
                  </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-3">
                <div class="form-group">
                  ...
                  <input id="chk" type="checkbox" name="noPaySurcharge" class="custom-control-input" >
