...
@section('title',trans('route.edit'))
    ...
    <div class="col-md-12">
      <div class="panel panel-primary">
        ...
        <div class="panel-body">
          ...
          {!! Form::model($route, array('route' => array('routes.update', $route->id), 'method' => 'PUT','id'=>'frmRol')) !!}
            <div class="row">
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <div class="input-group select2-bootstrap-prepend">
                    ...
                    {!! Form::text('name', Input::old('name',$route->name), array('class' => 'form-control')) !!}
                  </div>
                </div>
              </div>
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <div class="input-group select2-bootstrap-prepend">
                    ...
                    {!! Form::number('amount', Input::old('amount',$route->goal_amount), array('class' => 'form-control')) !!}
                  </div>
                </div>
              </div>
            </div>
                  ...
                  <div class="input-group select2-bootstrap-prepend">
                    ...
                    <select name="states" id="states" class="form-control">
                      @foreach($states as $key => $value)
                        <option value="{{$key}}" {{ old('states',$route->status_id) == $key ? 'selected' : '' }}>{{$value}}</option>
                      @endForeach
                    </select>
                  </div>
                </div>
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <div class="input-group select2-bootstrap-prepend">
                    ...
                    {!! Form::text('description', Input::old('description',$route->description), array('class' => 'form-control')) !!}
                  </div>
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-lg-12">
                <div class="form-group {{ $errors->has('permissions') ? 'has-error' : '' }}">
                  <label for="users">{{ trans('route.costumer') }}
						...
						<div class="modal-dialog" role="document">
							<div class="modal-content">
								<div class="modal-header bg-info">
									<h4 class="modal-title">Confirmación editar</h4>
								</div>
...
<script type="text/javascript">
  ...
  document.getElementById('amount').value=Math.abs(document.getElementById('amount').value);
