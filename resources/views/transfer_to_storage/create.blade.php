        ...
        <div class="panel panel-primary">
          ...
          <div class="panel-body">
            ...
            <ul class="nav nav-tabs" style="margin-bottom: 15px;">
              <li class="active">
                <a href="#home" id="tabTransfer" data-toggle="tab">{{trans('product_transfer.config')}}</a>
              </li>
              <li>
            ...
            <div id="myTabContent" class="tab-content">
              <div class="tab-pane fade active in" id="home">
                <div class="row">
                  ...
                  @if ($param)
                    <div class="col-lg-6">
                      ...
                      <select class="form-control" name="price_id" id="price_id" form="id_storage_origins_form"
                              onchange="refrescarForm(1)" required>
                        <option value="0">Precio costo</option>
                        @foreach($prices as $value)
                          <option value="{{$value->id}}" {{ ($price_id == $value->id) ?  'selected="selected"' : '' }}>
                            {{$value->name}}
                          </option>
                        @endforeach
                      </select>
                ...
                <div class="row">
                  {!! Form::open(array('url'=>'transfer_to_storage/create','id'=>'id_storage_origins_form', 'method'=>'post')) !!}
                  ...
                  <div class="col-lg-6">
                    ...
                    <select class="form-control" name="id_storage_destination" id="id_storage_destination"
                            onchange="getAccount('id_storage_destination', 'account_destination')">
                      <option value="">Seleccione una bodega</option>
                      @foreach($data_storage as $value)
                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <input type="hidden" name="payments" id="json_payments">
              ...
              <div class="tab-pane fade" id="profile">
                @include('transfer_to_storage.payment')
              </div>
            </div>
...
@section('footer_scripts')
  ...
  <script type="text/javascript" src="{{ asset('assets/js/transfer_to_storage/payment.js') }}"></script>
  <script type="text/javascript">
      $(document).ready(function () {
          ...
          /**
           * SI LA BODEGA DE ORIGEN ESTA SELECCIONADA BUSCAR SI ESTA ASOCIADA A UNA CUENTA
           */
          getAccount('id_storage_origins', 'account_origin');

          //FUNCION PARA RESTAURAR LOS PRODUCTOS
          ...
          $("#codigo").keydown(function (event) {
              if (event.which == 13) {
                  ...
                  if ((typeof $("#id_storage_origins").val() == '') || ($("#id_storage_origins").val() === "") || ($("#price_id").val() == null)) {
      ...
      function getAccount(control_id, selector) {
          ...
          showLoading("Verificando cuenta asociada..");
          $.ajax({
              method: 'get',
              url: APP_URL + '/almacen/account/' + control.value,
