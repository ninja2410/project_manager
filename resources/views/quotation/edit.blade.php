                                                        ...
                                                        @foreach ($details as $detail)
                                                            <tr>
                                                                ...
                                                                <td><input type="text"
                                                                           ...
                                                                           required="" class="input_price form-control mc"
                                                                ...
                                                                <td><input type="text"
                                                                           ...
                                                                           required="" min="1"
                                                                           max="Extra Grande"
                                                                           class="form-control input_quantity mc"
...
@section('footer_scripts')
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            // });
            $('.mc').toArray().forEach(function(field){
                new Cleave(field, {
                    numeral: true,
        ...
        function loadEdition() {
            ...
            for (var i = 0; i < inputs.length; i++) {
                inputs[i].addEventListener('change', function () {
                    ...
                    if (cantidad_cambio == "") {
                        ...
                        $('#total_storage_' + no_storage + '_id_item_' + no_id).val(total_temp.format(2));
                    ...
                    $('#total_general').val(general_temp.toFixed(2));
                    $('#total_general2').val(general_temp.format(2));
                    setPaymentValues(general_temp);
                });
            }
                ...
                inputs_price[i].addEventListener('change', function () {
                    ...
                    if (precio_cambio == "" || cleanNumber(precio_cambio) < 1) {
                        ...
                        if (cleanNumber(precio_cambio) < cleanNumber(low_price)) {
                            ...
                            general_temp = $('#total_general').val();
                            general_temp = cleanNumber(general_temp) - cleanNumber(anterior_precio) + cleanNumber(total_temp);
            ...
            var general_temp = $('#total_general').val();
            general_temp = cleanNumber(general_temp);
            $('#total_general').val(general_temp.toFixed(2));
            $('#total_general2').val(general_temp.format(2));
            setPaymentValues(general_temp);
            hideLoading();
        ...
        function autocomplete() {
            var options = {
                ...
                preparePostData: function (data) {
                    ...
                    if(data.price_id === 0)
                    {
                        toastr.error("Seleccione precio a aplicar.");
                        return;
                    }
                    return data;
                },
