        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style="margin-left: auto;margin-right: auto; display: block;">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group">
                            <table class="table table-bordered display compact" id="table_advanced" style="font-size: 11px;">
                                <thead>
                                <th>Código</th>
                                <th>Producto</th>
                                <th>Descripción</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button type='button' name='button'  onclick='add(this);' value="{{ $value->quantity }}" class='btn btn-primary btn-xs' id="{{ $value->id }}">
                                                {{-- <button class="btn btn-success btn-xs add-item" type="button" id="nuevo_{{ $i+1 }}" name="barra_{!! $value->upc_ean_isbn !!}" value="codig_barras_{{$value->upc_ean_isbn}}"  onclick="add(this)"> --}}
