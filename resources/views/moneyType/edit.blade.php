...
@section('page_parent',trans('general.update_currency_denomination'))
      ...
      <div class="panel panel-primary">
        <div class="panel-heading">
          <h3 class="panel-title">
            ...
            {{trans('general.update_currency_denomination')}}
          </h3>
        ...
        <div class="panel-body">
          ...
          <div class="col-lg-10">
            {!! Html::ul($errors->all()) !!}
            {!! Form::model($typeMoney, array('url' => 'typeMoney/update/'.$typeMoney->id, 'id'=>'newMoney')) !!}
            <div class="form-group">
              {!! Form::label('lblName', trans('Ingrese nombre de moneda ')) !!}
              {!! Form::text('name', Input::old('name'), array('class' => 'form-control')) !!}
            </div>
            <div class="form-group">
              {!! Form::label('lblUser', trans('Usuario asignado').' *') !!}
