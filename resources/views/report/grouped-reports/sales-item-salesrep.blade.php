        ...
        <div class="col-xs-12">
            <div class="panel panel-primary">
                ...
                @foreach ($data as $key => $value)
                    ...
                    <?php $nuevo = $value->groupBy('user_name'); $total_producto = 0;?>
                    ...
                    <li class="list-group-item" style="border: 1px solid #ddd;margin-top:0px;padding-top:0px;">
                        ...
                        <table class="table table-hover" style="width:100%">
                            ...
                            <tbody>
                                ...
                                @foreach ($v as $a => $b) 
                                    ...
                                    <tr style="font-size:12px">
                                        ...
                                        <td style="font-size:11px">{{$x['customer_name']}}</td>
                            ...
                            <tfoot style="page-break-before: always;">
                                ...
                                <td colspan="6" style="text-align:right;font-size:13px">TOTAL {{$k}}:</td>
                    ...
                    <table class="table" style="width:100%">
                        <thead>
                            <tr style="background-color: lightgray">
                                ...
                                <td style="text-align: right;font-size:13px;padding-right:10px"><strong>@money($total_producto)</strong></td>
