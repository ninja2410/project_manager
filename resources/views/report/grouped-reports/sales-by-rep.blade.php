                            ...
                            <tbody>
                                ...
                                @foreach ($value as $a => $b)
                                    ...
                                    <tr style="font-size:12px">
                                        ...
                                        <td style="font-size:11px">{{$b['item_name']}}</td>
                                        <td style="text-align: center">{{$b['quantity']}}</td>
                                        <td style="text-align: right">@money($b['selling_price'])</td>
                                        <td style="text-align: right">@money($b['total_selling'])</td>
                                        <?php $total +=$b['total_selling'];  ?>
                                    </tr>
                                @endforeach
                            </tbody>
                            <tfoot style="page-break-before: always;">
                                <tr style="padding-top: 3px;border: 1px solid #ddd;">
                                <td colspan="6" style="text-align:right;font-size:13px">TOTAL {{$key}}:</td>
