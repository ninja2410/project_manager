...
@section('title',trans('Actualizar rol'))
		...
		<div class="col-md-12">
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					...
					{!! Form::model($roles, array('route' => array('roles.update', $roles->id), 'method' => 'PUT', 'files' => true, 'id'=>'frmRol')) !!}
					<div class="col-md-10 col-md-offset-1">
						<div class="form-group">
							{!! Form::label('name', trans('Nombre').' *') !!}
							<input type="text" name="role" id="role" value="{!!$roles->role!!}" class="form-control">
						</div>
					</div>
					<div class="col-md-10 col-md-offset-1">
						...
						<div class="col-md-10 col-md-offset-1">
							<div class="form-group">
								...
								<select class="form-control" title="" name="is_admin" id="is_admin" required>
									<option value="0" @if($roles->admin === '0') selected="selected" @endif>No</option>
									<option value="1" @if($roles->admin === '1') selected="selected" @endif>Si</option>
								</select>
							</div>
						</div>
			...
			$('#frmRol').bootstrapValidator({
				...
				fields:{
					nameRole:{
						validators:{
							notEmpty:{
								message:'Debe ingresar nombre del nuevo rol.'
							},
							stringLength:{
								min:3,
