...
@section('title', trans('budget.create'))
        ...
        <div class="panel panel-primary">
          ...
          <div class="panel-body">
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    {!! Form::text('date', Input::old('date'), array('id'=>'date','class' => 'form-control date', 'form'=>'frmSend')) !!}
                  </div>
                </div>
              </div>
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    {!! Form::text('days', 15, array('id'=>'days','class' => 'form-control money', 'form'=>'frmSend')) !!}
                  </div>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              {!! Form::open(['url' => 'project/'.$project->id.'/budget/', 'method' => 'post', 'id'=>'frmSend']) !!}
            ...
            <div>
              @include('layouts.modal_confirm_generic', ['confirm' => "Desea guardar el presupuesto?"])
              @include('project.budget.components.confirm-error')
            </div>
          </div>
        </div>
      </div>
