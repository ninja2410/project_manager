...
@section('page_parent',"Editar Proyecto")
      ...
      <div class="col-md-12">
        <div class="panel panel-primary">
          ...
          <div class="panel-body">
            ...
            {!! Form::model($project, array('url' => 'project/projects/'. $project->id, 'id'=>'frmAdd', 'method' => 'PUT', 'files'=>true)) !!}
            <div class="row">
              <div class="col-lg-6">
              ...
              <div class="col-lg-3">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    {!! Form::text('code', $project->code,array('class' => 'form-control')) !!}
                  </div>
                </div>
              </div>
              <div class="col-lg-3">
                <div class="form-group">
                  {!! Form::label('lblDate', 'Fecha', array('class'=>'control-label')) !!}
                  <div class="input-group">
                                        <span class="input-group-addon"><li
                                                  class="glyphicon glyphicon-calendar"></li></span>
                    {!! Form::text('date', $date, array('class' => 'form-control date')) !!}
                  </div>
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-lg-6">
                    ...
                    <select class="form-control" name="customer_id" id="customer_id">
                      ...
                      @foreach($customer as $value)
                        <option value="{!! $value->id !!}"
                                @if($value->id==$project->customer_id) selected='selected' @endif>{{ $value->name }}
                        </option>
                      @endforeach
                    </select>
                ...
                {{-- <div class="form-group">
                  ...
                  <div class="input-group">
                    <input type="hidden" name="customer_id" value="{{$project->customer_id}}" id="customer_id">
                    <input type="hidden" name="user_relation" value="0" id="user_relation">
                    <input type="text" name="name_customer" style="width:400px; padding-right:5px;" value="{{$customer->find($project->customer_id)->name}}" id="name_customer" class="form-control" disabled>
              ...
              <div class="col-lg-3">
                <div class="form-group">
                  {!! Form::label('lblPrice', 'Precio acordado') !!}
                  <div class="input-group">
                    <span class="input-group-addon">Q</span>
                    {!! Form::text('price', $project->price, array('class' => 'form-control money')) !!}
                  </div>
                </div>
              </div>
              <div class="col-lg-3">
                  ...
                  <div class="input-group select2-bootstrap-prepend">
                    ...
                    <select class="form-control" name="type_id" id="type_id">
                      ...
                      @foreach($types as $value)
                        <option value="{!! $value->id !!}" @if ($project->type_id == $value->id)
                        selected
                                @endif>{{ $value->name }}
                        </option>
                      @endforeach
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    {!! Form::textarea('description', $project->description, array('class' => 'form-control', 'rows'=>'2')) !!}
                  </div>
                </div>
              </div>
              <div class="col-lg-6">
                ...
                <div class="form-group">
                  <div class="input-group">
                    ...
                    <input type="checkbox" {{$project->create_cellar ? 'checked' : ''}} name="create_cellar" class="form-control" id="create_cellar">
                  </div>
                </div>
                <div class="col-lg-6">
                ...
                <div class="form-group">
                  <div class="input-group">
                    <span class="input-group-addon"><i class="fa fa-cog"></i></span>
                    <input type="checkbox" {{$project->create_account ? 'checked' : ''}} name="create_account" class="form-control" id="create_account">
                  </div>
                </div>
              </div>
            </div>
              ...
              .bootstrapValidator({
                  ...
                  fields: {
                      ...
                      customer_id: {
                          validators: {
                              notEmpty: {
                                  message: 'Debe seleccionar a un cliente.'
                              }
                          }
                      },
                      type_id: {
                          validators: {
                              notEmpty: {
                                  message: 'Debe seleccionar tipo de proyecto.'
                              }
                          }
                      }
                  }
