            ...
            <div class="col-md-12">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        <input type="hidden" id="account_proyect_id" value="{{$project->account_id}}">
...
{{--                        </div>--}}
                        ...
                        <br>
                        <div class="col-lg-12">
                            @include('partials.buttons',['cancel_url'=>"/project/expenses/".$project->account_id])
                        </div>
                        {!! Form::close() !!}
                    </div>
                </div>
...
@section('footer_scripts')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            setAccount($('#account_proyect_id').val());
        });
