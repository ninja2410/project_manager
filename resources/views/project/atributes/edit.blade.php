  ...
  <div class="row">
    <div class="col-md-12">
        ...
        <div class="panel-body">
          ...
          {!! Form::model($atribute, array('url' => 'project/atributes/'.$atribute->id,'id'=>'frmAdd', 'method'=>'PUT')) !!}
            <div class="row">
              <div class="col-lg-6">
                <div class="form-group">
                  {!! Form::label('lblName', 'Nombre del atributo', array('class'=>'control-label')) !!}
                  <div class="input-group">
                    <span class="input-group-addon">T</span>
                    {!! Form::text('name', $atribute->name, array('class' => 'form-control')) !!}
                  </div>
                </div>
              </div>
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <select class="form-control" name="size">
                      ...
                      <option value="col-md-12" {!! $atribute->size=="col-md-12" ? "selected" : ""!!}>Grande</option>
                      <option value="col-md-6" {!! $atribute->size=="col-md-6" ? "selected" : ""!!}>Mediano</option>
                      <option value="col-md-3" {!! $atribute->size=="col-md-3" ? "selected" : ""!!}>Pequeño</option>
                    </select>
                  </div>
                </div>
              </div>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <select class="form-control" name="type">
                      <option value="">Seleccione una opción</option>
                      <option value="text" {!! $atribute->type=="text" ? "selected" : ""!!}>Texto</option>
                      <option value="number" {!! $atribute->type=="number" ? "selected" : ""!!}>Número</option>
                      <option value="checkbox" {!! $atribute->type=="checkbox" ? "selected" : ""!!}>Checkbox</option>
                      <option value="date" {!! $atribute->type=="date" ? "selected" : ""!!}>Fecha</option>
                    </select>
                  </div>
                </div>
              </div>
                  ...
                  <div class="input-group">
                    ...
                    <select class="form-control" name="stage_id">
                      ...
                      @foreach ($stages as $key => $stage)
                        <option value="{{$stage->id}}" {!! $atribute->stage_id==$stage->id ? "selected" : ""!!}>{{$stage->order}}) {{$stage->name}} | {{$stage->tipo->name}}</option>
                      @endforeach
                    </select>
                  </div>
                </div>
