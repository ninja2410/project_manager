                        ...
                        <div class="col-md-12">
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tr>
                                        <td colspan="3"
                                            style="text-align: center;"><strong>{{trans('reconciliation.tx_con')}}</strong></td>
                                    </tr>
                                    <tr>
                                        <td>(+){{trans('reconciliation.total_rev')}}</td>
                                        <td class="money">@money($reconciliation->recon_revenues)</td>
                                        <td></td>
                                    </tr>
                                    <tr>
                                        <td>(-){{trans('reconciliation.total_exp')}}</td>
                                        <td class="money">@money($reconciliation->recon_expenses)</td>
                                        <td></td>
                                    </tr>
                                    <tr>
                                        <td class="highlight"><strong>{{trans('reconciliation.bank_balance')}}</strong></td>
                                        <td></td>
                                        <td class="money"><strong>@money($reconciliation->recon_revenues-$reconciliation->recon_expenses)</strong></td>
                                    </tr>
                                    <tr>
                                        <td colspan="3"
                                            style="text-align: center;"><strong>{{trans('reconciliation.tx_no_con')}}</strong></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr class="summary">
                                        <td><strong>{{trans('reconciliation.total_no_con')}}</strong></td>
                                        <td></td>
                                        <td class="money"><strong>@money($reconciliation->transit_revenue-$reconciliation->outstanding_payments)</strong></td>
                                    </tr>
                                    <tr class="footer_summary">
                                        <td><strong>{{trans('reconciliation.countable_balance')}}</strong></td>
                                        <td></td>
                                        <td class="money"><strong>@money($reconciliation->countable_balance)</strong></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr class="report_summary">
                                        <td><strong>{{trans('reconciliation.diference')}}</strong></td>
                                        <td></td>
                                        <td class="money"><strong>@money($reconciliation->countable_balance-$reconciliation->bank_balance)</strong></td>
                                    </tr>
                                    </tbody>
                                </table>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    @if ($reconciliation->comment!='')
                                        <strong>{{trans('reconciliation.comment')}}:</strong> {{$reconciliation->comment}}
                                    @endif
                                </div>
                            </div>
                            {{--                            table-responsive--}}
