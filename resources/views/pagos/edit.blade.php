						...
						<div class="col-lg-6">
							<div class="form-group">
								...
								<select class="form-control" title="" name="type" id="type" required>
									...
									<option value="3" @if($pagoss->type === '3') selected="selected" @endif>Depósito</option>
									<option value="4" @if($pagoss->type === '4') selected="selected" @endif>Tarjeta de Crédito/Debito</option>
									<option value="5" @if($pagoss->type === '5') selected="selected" @endif>Transferencia</option>
									<option value="6" @if($pagoss->type === '6') selected="selected" @endif>Crédito</option>
								</select>
							</div>
						</div>						
					</div>
