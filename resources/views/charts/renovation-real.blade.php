    ...
    var dom = document.getElementById("container");
            ...
            option = {
              toolbox: {
                ...
                title : {
                  @if ($ruta==0)
                    text: 'Gráfica real de renovación: General',
                    @else
                    text: 'Gráfica real de renovación: {{$rutas->find($ruta)->name}}',
                  @endif

                    subtext: 'Comparación de monto cobrado vs montos renovados',
                    x:'center'
                },
                tooltip : {
                    trigger: 'item',
                ...
                series : [
                    {
                        ...
                        data:[
                            ...
                            {value:(parseFloat($('#totalCobrado').val())-parseFloat($('#totalRenovado').val())), name:'Líquido'}
                        ],
                        itemStyle: {
                            emphasis: {
                                shadowBlur: 10,
