...
@section('title',trans('item.new_price'))
      ...
      <div class="col-md-12">
        <div class="panel panel-primary">
          ...
          <div class="panel-body">
            ...
            {!! Form::open(array('url' => 'prices','id'=>'frmPrices')) !!}
            <div class="row">
              <div class="col-lg-4">
              ...
              <div class="col-lg-4">
                <div class="form-group">
                  ...
                  {!! Form::text('pct', Input::old('pct'), array('class' => 'form-control number', 'id'=>'pct')) !!}
                </div>
              </div>
              <div class="col-lg-4">
                <div class="form-group">
                  {!! Form::label('pct_min', trans('item.price_pct_min').' *',  array('class' => 'control-label')) !!}
                  {!! Form::text('pct_min', Input::old('pct_min'), array('class' => 'form-control number')) !!}
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-lg-3">
                <div class="form-group">
                  ...
                  {!! Form::text('amount', Input::old('amount'), array('class' => 'form-control number')) !!}
                </div>
              </div>
              <div class="col-lg-3">
                <div class="form-group">
                  {!! Form::label('amount_min', trans('item.price_amount'),  array('class' => 'control-label')) !!}
                  {!! Form::text('amount_min', Input::old('amount_min'), array('class' => 'form-control number')) !!}
                </div>
              </div>
              <div class="col-lg-3">
                <div class="form-group">
                  {!! Form::label('cant_min', trans('item.cant_min'),  array('class' => 'control-label')) !!}
                  {!! Form::text('cant_min', Input::old('cant_min'), array('class' => 'form-control number')) !!}
                </div>
              </div>
              <div class="col-lg-3">
                <div class="form-group">
                  {!! Form::label('cant_max', trans('item.cant_max'),  array('class' => 'control-label')) !!}
                  {!! Form::text('cant_max', Input::old('cant_max'), array('class' => 'form-control number')) !!}
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-lg-3">
                <div class="form-group">
                  ...
                  {!! Form::text('date_min', Input::old('date_min'), array('class' => 'form-control fechas')) !!}
                </div>
              </div>
              <div class="col-lg-3">
                <div class="form-group">
                  {!! Form::label('date_max', trans('item.date_max'),  array('class' => 'control-label')) !!}
                  {!! Form::text('date_max', Input::old('date_max'), array('class' => 'form-control fechas')) !!}
                </div>
              </div>
              <div class="col-lg-3">
                <div class="form-group">
                  {!! Form::label('order', trans('item.order'),  array('class' => 'control-label')) !!}
                  {!! Form::text('order', Input::old('order'), array('class' => 'form-control number')) !!}
                </div>
              </div>
              <div class="col-lg-3">
                <div class="form-group">
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  {!! Form::label('active', trans('item.active')) !!}
            ...
            <div class="row">
              <div class="col-lg-12">
                <label for="items" class="control-label">{{ trans('item.list_items') }}*
                  <span class="btn btn-info btn-xs select-all">{{ trans('general.select_all') }}</span>
                  <span class="btn btn-info btn-xs deselect-all">{{ trans('general.deselect_all') }}</span></label>
