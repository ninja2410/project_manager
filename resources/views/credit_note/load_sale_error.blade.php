                                    ...
                                    <table>
                                        ...
                                        @foreach ($newdetail as $key => $detail)
                                            <tr>
                                                ...
                                                <td class="unit">
                                                    <input style="text-align: center" type="number" max_value="{{$detail['cellar']}}" min="0" detail_id="{{$detail['detail_id']}}" class="form-control new_quantity" value="{{$detail['quantity']}}">
                                                </td>
                                                <td
    ...
    <script>
        function newQuantity(){
            ...
            for (var i =0; i<inputs.length; i++){
                if (+inputs[i].value > +$(inputs[i]).attr('max_value')){
