    ...
    <div class="modal-content">
      ...
      <div class="modal-body" style="margin-left: auto;margin-right: auto; display: block;">
        <div class="row">
          ...
          <div class="col-lg-2">
            <div class="form-group">
              <label id="labelNombreBodega"></label>
            </div>
          </div>
          <div class="col-lg-8">
          </div>
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="form-group">
              <table class="table table-bordered display compact" id="table_advanced" style="font-size: 13px;width: 100%;">
                {{-- <table class="table table-striped table-bordered display" id="table_advanced"> --}}
                <thead>
                  <tr>
                    <th>Código</th>
                    <th>Producto</th>
                ...
                {{-- <tbody>
                  ...
                  <tr>
                    ...
                    <td style="text-align:right;">@money($value->selling_price)</td>
                    <td>
                      ...
                      <input type="hidden" id="precio_{{ $value->id }}" value="{{ $value->selling_price }}">
