				...
				<div class="panel-body">
					...
					<div class="col-lg-6">
						<div class="form-group">
							...
							<input type="text" name="" value="{{$expiration_date}}" class="form-control" id="expiration_date">
						</div>
					</div>

					<!-- <div class="form-group">
					{!! Form::label('quantity', trans('item.quantity')) !!}
					{!! Form::text('quantity', Input::old('quantity'), array('id'=>'precio_minimo','class' => 'form-control'))   !!}
					</div> -->
					<div class="col-lg-12">
...
var setValorPrecioVenta=function(e){
	...
	if(precioMinimo < precioCompra){
		mensaje.innerHTML="<div class='alert alert-danger'><strong>El precio minimo no puede ser menor al precio costo...</strong></div>";
		precio_minimo.value=precio_compra.value;
	}
}
precio_venta.addEventListener('blur',setValorPrecioMinimo);
precio_minimo.addEventListener('blur',setValorPrecioVenta);
