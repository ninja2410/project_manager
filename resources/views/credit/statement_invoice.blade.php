            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body table-responsive">
                    ...
                    <table class="table table-striped table-bordered compact" id="table1">
                        ...
                        <tr>
                            <th></th>
                            <th data-priority="2" style="width: 9%;">{{trans('credit.date')}}</th>
                            <th data-priority="3" style="width: 10%;">{{trans('credit.document')}}</th>
                        ...
                        <tr>
                            ...
                            <td></td>
                            <td>{{$credit->invoice->sale_date}}</td>
                            <td>{{$name_sale}}</td>
                        ...
                        @foreach($details as $i=> $value)
                            <tr>
                                ...
                                <td>{{'Recibo #'.$value->revenue->receipt_number}}</td>
                                <td>{{$value->revenue->pago->name}}</td>
                                <td>{{ $value->comment }}</td>
                                <td></td>
                                <td style="text-align:right">@money(0)</td>
