...
@section('title',trans('inventory_adjustment.inventory_entry'))
            ...
            <div class="panel panel-primary">
                <div class="panel-heading clearfix">
                    <h4 class="panel-title pull-left"><i class="livicon" data-name="list-ul" data-size="16"
                        ...
                        {{trans('inventory_adjustment.inventory_entry')}}
                    </h4>
                    <div class="pull-right">
                        <a href="{{ URL::to('/inventory_adjustment/input') }}" class="btn btn-sm btn-default"><span
                                    class="glyphicon glyphicon-plus"></span> Nuevo ajuste </a>
                    </div>
                </div>
                <div class="panel-body">
                    {!! Form::open(array('url'=>'/inventory_adjustment/index/input')) !!}
                    <div class="row">
                            <div class="col-md-6">
                                ...
                                <table class="table table-bordered table-striped" id="table1">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ URL::to('inventory_adjustment/detail/input/'.$value->id) }}"  class="btn btn-success" title="Re-imprimir">
