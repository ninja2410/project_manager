...
return [
    ...
    'custom' => [
        ...
        'item_name' => [
            'unique' => 'El nombre de producto debe ser único, utilice la descripción para diferenciar los artículos similares.',
        ],
        'name' => [
            'unique' => 'El nombre ingresado ya existe.',
        ],
        'customer_code' => [
            'unique' => 'El código de cliente ingresado ya existe.',
        ],
        'arrears'=>[
          'unique'=>'El número de días de retraso ya esta aplicado en otra clase.'
        ],
        'nit_customer'=>[
            'unique'=>'El Nit ya existe, verifique si esta creando un cliente duplicado.',
            'required'=> 'Nit del cliente es requerido',
          ],
        'nit_supplier'=>[
            'required' =>'Nit del proveedor es requerido',
            'unique'=> 'El Nit ya existe, verifique si esta creando un proveedor duplicado.',
        ],
        'company_name' => [
            'required' => 'El nombre del proveedor es requerido.',
            'unique'=>'El nombre de proveedor ya existe.'
        ],
        'selling_price' => [
            'required' => 'El precio de venta es requerido'
        ],
        'item_kit_name' => [
            'required' => 'El nombre del Kit es requerido'
        ],
        'account_name' => [
            'required' => 'El nombre de la cuenta es requerido.',
            'unique'   => 'El nombre de cuenta ya existe.'
        ],
        'role' => [
